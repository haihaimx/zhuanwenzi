...
(function(vue) {
  ...
  const API_CONFIG = {
    ...
    apiKey: "sk-ZAaqR8Us17y9HhF5447aDbFdE2Fa4a738029Cf6c6f7a8336",
    // 内置API密钥
    timeout: 6e4
    // 60秒超时
  };
        ...
        success: (res) => {
          ...
          try {
            ...
            if (res.statusCode === 200) {
              ...
              const errorMessage = ((_a = data.error) == null ? void 0 : _a.message) || data.message || `请求失败 (${res.statusCode})`;
              reject(new Error(errorMessage));
            }
          } catch (parseError) {
            formatAppLog("error", "at utils/api.js:120", "解析响应数据失败:", parseError);
            reject(new Error("解析响应数据失败"));
          }
        },
        fail: (error) => {
          uni.hideLoading();
          formatAppLog("error", "at utils/api.js:126", "上传文件失败:", error);
  ...
  function saveTranscriptionHistory(record) {
    return new Promise((resolve, reject) => {
      try {
        ...
        uni.setStorage({
          ...
          fail: (error) => {
            formatAppLog("error", "at utils/storage.js:63", "保存历史记录失败:", error);
            reject(new Error("保存历史记录失败"));
          }
        });
      } catch (error) {
        formatAppLog("error", "at utils/storage.js:68", "保存历史记录异常:", error);
        reject(error);
      }
    });
  }
  ...
  function getTranscriptionHistorySync() {
    try {
      const history = uni.getStorageSync(STORAGE_KEYS.HISTORY);
      return Array.isArray(history) ? history : [];
    } catch (error) {
      formatAppLog("error", "at utils/storage.js:103", "获取历史记录失败:", error);
      return [];
    }
  }
  function deleteTranscriptionHistory(index) {
    return new Promise((resolve, reject) => {
      try {
        ...
        uni.setStorage({
          ...
          fail: (error) => {
            formatAppLog("error", "at utils/storage.js:134", "删除历史记录失败:", error);
            reject(new Error("删除历史记录失败"));
          }
        });
      } catch (error) {
        formatAppLog("error", "at utils/storage.js:139", "删除历史记录异常:", error);
        reject(error);
      }
    });
  }
  function clearTranscriptionHistory() {
    return new Promise((resolve, reject) => {
      uni.removeStorage({
        ...
        fail: (error) => {
          formatAppLog("error", "at utils/storage.js:195", "清空历史记录失败:", error);
  ...
  function getHistoryStatistics() {
    return new Promise((resolve, reject) => {
      try {
        ...
        formatAppLog("error", "at utils/storage.js:255", "获取统计信息异常:", error);
        reject(error);
      }
    });
  }
  function saveAppSettings(settings) {
    return new Promise((resolve, reject) => {
      uni.setStorage({
        ...
        fail: (error) => {
          formatAppLog("error", "at utils/storage.js:275", "保存设置失败:", error);
  ...
  function exportHistoryAsJson() {
    return new Promise((resolve, reject) => {
      try {
        ...
        formatAppLog("error", "at utils/storage.js:338", "导出历史记录异常:", error);
        reject(error);
      }
    });
  }
  ...
  function validateFileFormat(fileName, allowedFormats = SUPPORTED_FORMATS.all) {
    const result = {
      isValid: false,
      fileExtension: "",
      fileType: "",
  ...
  function handleError(error, context = {}) {
    ...
    try {
      ...
      formatAppLog("error", "at utils/validator.js:312", "Error handled:", errorInfo);
      return errorInfo;
    } catch (handlingError) {
      formatAppLog("error", "at utils/validator.js:317", "Error handling failed:", handlingError);
      return {
        message: "错误处理失败",
        type: ERROR_TYPES.UNKNOWN_ERROR,
  ...
  const _imports_0$1 = "/static/upload-icon.png";
  const _imports_1 = "/static/file-icon.png";
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      ...
      vue.createElementVNode("view", { class: "upload-section" }, [
        vue.createElementVNode("view", {
          ...
          !$data.selectedFile ? (vue.openBlock(), vue.createElementBlock("view", {
            ...
            vue.createElementVNode("text", { class: "upload-text" }, "点击选择音频/视频文件"),
            vue.createElementVNode("text", { class: "upload-tip" }, "支持格式：mp3、mp4、wav、m4a等")
        ...
        vue.createCommentVNode(" 转录按钮 "),
        vue.createElementVNode("button", {
          class: "transcribe-btn",
          disabled: !$data.selectedFile || $data.isTranscribing,
          onClick: _cache[1] || (_cache[1] = (...args) => $options.startTranscription && $options.startTranscription(...args))
        }, [
          !$data.isTranscribing ? (vue.openBlock(), vue.createElementBlock("text", { key: 0 }, "开始转录")) : (vue.openBlock(), vue.createElementBlock("text", { key: 1 }, "转录中..."))
        ], 8, ["disabled"])
      ]),
      vue.createCommentVNode(" 转录结果区域 "),
      $data.transcriptionResult ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "result-section"
      }, [
        vue.createElementVNode("view", { class: "result-header" }, [
          vue.createElementVNode("text", { class: "result-title" }, "转录结果"),
          vue.createElementVNode("button", {
            class: "copy-btn",
            onClick: _cache[2] || (_cache[2] = (...args) => $options.copyResult && $options.copyResult(...args))
          }, "复制")
        ]),
        vue.createElementVNode("view", { class: "result-content" }, [
          vue.createElementVNode(
            "text",
            { class: "result-text" },
            vue.toDisplayString($data.transcriptionResult),
            1
            /* TEXT */
          )
        ])
      ...
      $data.isTranscribing ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 1,
        class: "loading-overlay"
      }, [
        vue.createElementVNode("view", { class: "loading-content" }, [
          vue.createElementVNode("view", { class: "loading-spinner" }),
          vue.createElementVNode("text", { class: "loading-text" }, "正在转录中，请稍候...")
        ])
      ])) : vue.createCommentVNode("v-if", true)
    ]);
  }
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-1cf27b2a"], ["__file", "C:/Users/20766/Desktop/xinxiangmu/无水印解析/转文字/转文字/pages/index/index.vue"]]);
  const _imports_0 = "/static/search-icon.png";
    ...
    computed: {
      filteredHistory() {
        ...
        return this.historyList.filter(
          (item) => item.fileName.toLowerCase().includes(this.searchKeyword.toLowerCase()) || item.result.toLowerCase().includes(this.searchKeyword.toLowerCase())
        );
      }
    },
    onShow() {
    ...
    methods: {
      ...
      async loadHistory() {
        try {
          ...
          this.historyList.sort((a2, b2) => b2.timestamp - a2.timestamp);
        } catch (error) {
          formatAppLog("error", "at pages/history/history.vue:124", "加载历史记录失败:", error);
        }
      },
      // 搜索输入
      onSearchInput() {
  ...
  function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      ...
      $options.filteredHistory.length > 0 ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "history-list"
      }, [
        (vue.openBlock(true), vue.createElementBlock(
          vue.Fragment,
          null,
          vue.renderList($options.filteredHistory, (item, index) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              ...
              vue.createElementVNode("view", { class: "item-header" }, [
                ...
                vue.createElementVNode("view", { class: "item-actions" }, [
                  vue.createElementVNode("button", {
                    class: "copy-btn",
                    onClick: vue.withModifiers(($event) => $options.copyText(item.result), ["stop"])
                  }, "复制", 8, ["onClick"]),
                  vue.createElementVNode("button", {
                    class: "delete-btn",
              ...
              vue.createElementVNode("view", { class: "item-content" }, [
                vue.createElementVNode(
                  ...
                  vue.toDisplayString($options.getPreviewText(item.result)),
                  1
                  /* TEXT */
                )
              ]),
              vue.createElementVNode("view", { class: "item-footer" }, [
                ...
                vue.createElementVNode(
                  "text",
                  { class: "word-count" },
                  vue.toDisplayString($options.getWordCount(item.result)) + " 字",
                  1
                  /* TEXT */
                )
              ])
        ...
        [
          ...
          vue.createElementVNode("view", { class: "empty-state" }, [
            ...
            vue.createElementVNode(
              "text",
              { class: "empty-text" },
              vue.toDisplayString($data.searchKeyword ? "未找到相关记录" : "暂无转录记录"),
              1
              /* TEXT */
            ),
            vue.createElementVNode(
              "text",
              { class: "empty-tip" },
              vue.toDisplayString($data.searchKeyword ? "尝试其他关键词" : "去首页开始转录吧"),
              1
              /* TEXT */
            )
          ])
      ...
      $data.showDetail ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 2,
        class: "detail-modal",
        onClick: _cache[7] || (_cache[7] = (...args) => $options.closeDetail && $options.closeDetail(...args))
      }, [
        vue.createElementVNode("view", {
          ...
          vue.createElementVNode("view", { class: "detail-header" }, [
            vue.createElementVNode("text", { class: "detail-title" }, "转录详情"),
            vue.createElementVNode("button", {
              class: "close-btn",
          ...
          vue.createElementVNode("view", { class: "detail-info" }, [
            vue.createElementVNode("view", { class: "info-row" }, [
              vue.createElementVNode("text", { class: "info-label" }, "文件名："),
              vue.createElementVNode(
                "text",
                { class: "info-value" },
                vue.toDisplayString($data.selectedItem.fileName),
                1
                /* TEXT */
              )
            ]),
            vue.createElementVNode("view", { class: "info-row" }, [
              vue.createElementVNode("text", { class: "info-label" }, "转录时间："),
              vue.createElementVNode(
                "text",
                { class: "info-value" },
                vue.toDisplayString($options.formatTime($data.selectedItem.timestamp)),
                1
                /* TEXT */
              )
            ]),
            vue.createElementVNode("view", { class: "info-row" }, [
              vue.createElementVNode("text", { class: "info-label" }, "字数统计："),
              vue.createElementVNode(
                "text",
                { class: "info-value" },
                vue.toDisplayString($options.getWordCount($data.selectedItem.result)) + " 字",
                1
                /* TEXT */
              )
            ])
          ]),
          vue.createElementVNode("view", { class: "detail-result" }, [
            vue.createElementVNode("text", { class: "result-title" }, "转录结果："),
            vue.createElementVNode("view", { class: "result-text-container" }, [
              vue.createElementVNode(
                "text",
                { class: "result-text" },
                vue.toDisplayString($data.selectedItem.result),
                1
                /* TEXT */
              )
            ])
          ...
          vue.createElementVNode("view", { class: "detail-actions" }, [
            vue.createElementVNode("button", {
              ...
              onClick: _cache[4] || (_cache[4] = ($event) => $options.copyText($data.selectedItem.result))
            }, "复制文本"),
            vue.createElementVNode("button", {
              class: "action-btn share-btn",
              onClick: _cache[5] || (_cache[5] = ($event) => $options.shareText($data.selectedItem.result))
            }, "分享")
          ])
        ])
      ])) : vue.createCommentVNode("v-if", true)
  ...
  const PagesHistoryHistory = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-b2d018fa"], ["__file", "C:/Users/20766/Desktop/xinxiangmu/无水印解析/转文字/转文字/pages/history/history.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        languageOptions: [],
    ...
    methods: {
      ...
      async loadSettings() {
        try {
          ...
          formatAppLog("error", "at pages/settings/settings.vue:157", "加载设置失败:", error);
        }
      },
      // 加载统计信息
      async loadStatistics() {
        try {
          ...
          formatAppLog("error", "at pages/settings/settings.vue:168", "加载统计信息失败:", error);
        }
      },
      // 测试API连接
      ...
      // 语言选择变化
      async onLanguageChange(e2) {
        this.languageIndex = e2.detail.value;
        await this.saveSettings();
      },
      // 温度变化
      async onTemperatureChange(e2) {
        this.temperature = e2.detail.value;
        await this.saveSettings();
      },
      // 自动保存变化
      async onAutoSaveChange(e2) {
        this.autoSave = e2.detail.value;
        await this.saveSettings();
      },
      // 保存设置
      async saveSettings() {
        try {
          ...
          formatAppLog("error", "at pages/settings/settings.vue:224", "保存设置失败:", error);
        }
      },
      // 导出历史记录
      async exportHistory() {
        try {
          ...
          formatAppLog("log", "at pages/settings/settings.vue:237", "导出数据:", jsonData);
        } catch (error) {
          uni.showToast({
            title: "导出失败",
            icon: "none"
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      vue.createCommentVNode(" API状态显示 "),
      vue.createElementVNode("view", { class: "card" }, [
        vue.createElementVNode("view", { class: "card-header" }, [
          vue.createElementVNode("text", { class: "card-title" }, "API状态"),
          vue.createElementVNode("button", {
        ...
        vue.createElementVNode("view", { class: "card-content" }, [
          vue.createElementVNode("view", { class: "status-info" }, [
            vue.createElementVNode("view", { class: "status-item" }, [
              vue.createElementVNode("text", { class: "status-label" }, "API密钥状态"),
              vue.createElementVNode("text", { class: "status-value success" }, "已配置")
            ]),
            vue.createElementVNode("view", { class: "status-item" }, [
              vue.createElementVNode("text", { class: "status-label" }, "服务地址"),
              vue.createElementVNode("text", { class: "status-value" }, "https://api.lightai.io")
            ])
          ]),
          vue.createElementVNode("text", { class: "help-text" }, "API密钥已内置，无需手动配置")
        ])
      ]),
      vue.createCommentVNode(" 转录设置 "),
      vue.createElementVNode("view", { class: "card" }, [
        vue.createElementVNode("view", { class: "card-header" }, [
          vue.createElementVNode("text", { class: "card-title" }, "转录设置")
        ]),
        vue.createElementVNode("view", { class: "card-content" }, [
          vue.createElementVNode("view", { class: "setting-item" }, [
            vue.createElementVNode("text", { class: "setting-label" }, "默认语言"),
            vue.createElementVNode("picker", {
              value: $data.languageIndex,
              range: $data.languageOptions,
              "range-key": "name",
              onChange: _cache[1] || (_cache[1] = (...args) => $options.onLanguageChange && $options.onLanguageChange(...args))
            }, [
              vue.createElementVNode("view", { class: "picker-value" }, [
                vue.createTextVNode(
                  vue.toDisplayString($data.languageOptions[$data.languageIndex].name) + " ",
                  1
                  /* TEXT */
                ),
          ...
          vue.createElementVNode("view", { class: "setting-item" }, [
            vue.createElementVNode("text", { class: "setting-label" }, "采样温度"),
            vue.createElementVNode("slider", {
              value: $data.temperature,
              min: 0,
              max: 1,
              step: 0.1,
              onChange: _cache[2] || (_cache[2] = (...args) => $options.onTemperatureChange && $options.onTemperatureChange(...args)),
              "show-value": ""
            }, null, 40, ["value"]),
            vue.createElementVNode("text", { class: "setting-desc" }, "较低的值使输出更确定，较高的值使输出更随机")
          ]),
          vue.createElementVNode("view", { class: "setting-item" }, [
            vue.createElementVNode("view", { class: "setting-row" }, [
              vue.createElementVNode("text", { class: "setting-label" }, "自动保存历史"),
              vue.createElementVNode("switch", {
                checked: $data.autoSave,
                onChange: _cache[3] || (_cache[3] = (...args) => $options.onAutoSaveChange && $options.onAutoSaveChange(...args)),
                color: "#007AFF"
              }, null, 40, ["checked"])
            ]),
            vue.createElementVNode("text", { class: "setting-desc" }, "转录完成后自动保存到历史记录")
          ])
        ])
      ]),
      vue.createCommentVNode(" 存储设置 "),
      vue.createElementVNode("view", { class: "card" }, [
        vue.createElementVNode("view", { class: "card-header" }, [
          vue.createElementVNode("text", { class: "card-title" }, "存储管理")
        ]),
        vue.createElementVNode("view", { class: "card-content" }, [
          vue.createElementVNode("view", { class: "storage-info" }, [
            vue.createElementVNode("view", { class: "info-item" }, [
              vue.createElementVNode("text", { class: "info-label" }, "历史记录数量"),
              vue.createElementVNode(
                "text",
                { class: "info-value" },
                vue.toDisplayString($data.historyCount) + " 条",
                1
                /* TEXT */
              )
            ]),
            vue.createElementVNode("view", { class: "info-item" }, [
              vue.createElementVNode("text", { class: "info-label" }, "总字数"),
              vue.createElementVNode(
                "text",
                { class: "info-value" },
                vue.toDisplayString($data.totalWords) + " 字",
                1
                /* TEXT */
              )
            ])
          ]),
          vue.createElementVNode("view", { class: "storage-actions" }, [
            vue.createElementVNode("button", {
              class: "btn btn-secondary",
              onClick: _cache[4] || (_cache[4] = (...args) => $options.exportHistory && $options.exportHistory(...args))
            }, "导出历史"),
            vue.createElementVNode("button", {
              class: "btn btn-secondary",
              onClick: _cache[5] || (_cache[5] = (...args) => $options.importHistory && $options.importHistory(...args))
            }, "导入历史"),
            vue.createElementVNode("button", {
              class: "btn btn-danger",
              onClick: _cache[6] || (_cache[6] = (...args) => $options.clearHistory && $options.clearHistory(...args))
            }, "清空历史")
          ])
        ])
      ]),
      vue.createCommentVNode(" 关于应用 "),
      vue.createElementVNode("view", { class: "card" }, [
        vue.createElementVNode("view", { class: "card-header" }, [
          vue.createElementVNode("text", { class: "card-title" }, "关于应用")
        ]),
        vue.createElementVNode("view", { class: "card-content" }, [
          vue.createElementVNode("view", { class: "about-info" }, [
            vue.createElementVNode("view", { class: "info-item" }, [
              vue.createElementVNode("text", { class: "info-label" }, "应用名称"),
              vue.createElementVNode("text", { class: "info-value" }, "音频转文字")
            ]),
            vue.createElementVNode("view", { class: "info-item" }, [
              vue.createElementVNode("text", { class: "info-label" }, "版本号"),
              vue.createElementVNode("text", { class: "info-value" }, "1.0.0")
            ]),
            vue.createElementVNode("view", { class: "info-item" }, [
              vue.createElementVNode("text", { class: "info-label" }, "支持格式"),
              vue.createElementVNode("text", { class: "info-value" }, "mp3, mp4, wav, m4a, ogg, webm, flac")
            ])
          ])
        ])
      ])
  ...
  const PagesSettingsSettings = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-7fad0a1c"], ["__file", "C:/Users/20766/Desktop/xinxiangmu/无水印解析/转文字/转文字/pages/settings/settings.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/20766/Desktop/xinxiangmu/无水印解析/转文字/转文字/App.vue"]]);
  const pages = [
    {
      path: "pages/index/index",
      style: {
        navigationBarTitleText: "音频转文字",
  ...
  const b = true, E = "app", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.44.1","192.168.183.1","192.168.31.86"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"admin","spaceId":"mp-84f43016-26b2-4fce-a94c-4be825f07b47","clientSecret":"7aljx5O14rjXIyUA5Cnsfg==","endpoint":"https://api.next.bspapp.com"}]') || [];
  let N = "";
  try {
    N = "__UNI__30E2AEE";
  } catch (e2) {
